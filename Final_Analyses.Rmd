...
fit_Peer_BMWLC_NR2 <- lavaan(Peer_BMWLC_NR2, data=data_wide, missing="FIML", estimator="MLR")
...
fit_Peer_BMWLC_IR2 <- lavaan(Peer_BMWLC_IR2, data=data_wide, missing="FIML", estimator="MLR")
inspect(fit_Peer_BMWLC_IR2,"cor.lv")
...
fit_Peer_BMWLC_IS2 <- lavaan(Peer_BMWLC_IS2, data=data_wide, missing="FIML", estimator="MLR")
...
There are the same models as above but using item-level data. They typically did not converge, therefore the composite scores are used instead.
