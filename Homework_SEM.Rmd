...
model.bi <- '
    ...
    # add time-invariant covariates
              i.p ~ T1Income_to_Need_c + IQ + T1_ACES_sum + rel_affective + rel_MDD + mom_MDDBP
              s.p ~ T1Income_to_Need_c + IQ + T1_ACES_sum + rel_affective + rel_MDD + mom_MDDBP
              i.d ~ T1Income_to_Need_c + IQ + T1_ACES_sum + rel_affective + rel_MDD + mom_MDDBP
              s.d ~ T1Income_to_Need_c + IQ + T1_ACES_sum + rel_affective + rel_MDD + mom_MDDBP
